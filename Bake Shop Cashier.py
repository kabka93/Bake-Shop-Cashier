...
BottomMainFrame = Frame (root, background = 'RoyalBlue1', width =1350, height=650, bd= 12, relief="raise")
BottomMainFrame.pack(side=BOTTOM)

f1 = Frame (BottomMainFrame, background = 'khaki1', width = 450 , height=650, bd= 12, relief="raise")
f1.pack(side=LEFT)
f2 = Frame (BottomMainFrame,background = 'khaki2', width = 450 , height=650, bd= 12, relief="raise")
f2.pack(side=LEFT)
f2TOP = Frame (f2,background = 'khaki3', width = 450 , height=450, bd= 4, relief="raise")
f2TOP .pack(side=TOP)
f2BOTTOM = Frame (f2,background = 'khaki4', width = 450 , height=300, bd= 4, relief="raise")
f2BOTTOM.pack(side=BOTTOM)

f3 = Frame (BottomMainFrame,background = 'LightGoldenRod1' , width = 450 , height=650, bd= 12, relief="raise")
f3 .pack(side=RIGHT)
